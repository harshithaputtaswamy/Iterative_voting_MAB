...
for key in input_conf.keys():
    ...
    plt.show()
    if voting_rule == "approval":
        graph_file = 'tie_breaking_rule_comp_avg_ties_setting_{}_{}_test_config_{}_approval_count_{}_voter_'.format(voting_setting, voting_rule, key, approval_count) + str(num_voters) + '_cand_' + str(num_candidates) + \
                    "_committee_size_" + str(committee_size) + "_iter_" + str(iterations) + "_avg_" + str(avg_runs) + '.png'
    else:
        graph_file = 'tie_breaking_rule_comp_avg_ties_setting_{}_{}_test_config_{}_voter_'.format(voting_setting, voting_rule, key) + str(num_voters) + '_cand_' + str(num_candidates) + \
                    "_committee_size_" + str(committee_size) + "_iter_" + str(iterations) + "_avg_" + str(avg_runs) + '.png'
    graph_path = os.path.join(curr_dir + "/graph_results/tie_breaking_rules_study/" + voting_rule + "/", graph_file)
