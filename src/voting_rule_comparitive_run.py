...
# voting_rule_list = ["borda", "borda_top_cand", "approval", "plurality", "anti_plurality", "chamberlin_courant", "bloc", "monroe", "stv", "pav"]
...
for voting_rule_type in voting_rules_list_dict.keys():
    ...
    result["run_setting"] = {
        ...
        "batch" : batch,
        "voting_rule_list" : voting_rules_list_dict[voting_rule_type],
