...
for committee_size in committee_size_list:
    ...
    if voting_rule == "approval":
        ...
        for approval_count in approval_count_list:
            ...
            plt.show()
            plt.savefig('results/setting_{}_approval_count_{}_voter_{}_cand_{}_committee_size_{}_iter_{}_avg_{}.png'\
                        .format(voting_setting, approval_count, num_voters, num_candidates, committee_size, iterations, avg_runs))
        ...
        plt.show()
        graph_file = 'setting_{}_{}_voter_'.format(voting_setting, voting_rule) + str(num_voters) + '_cand_' + str(num_candidates) + \
